...
GaussianFilter_ROM_9X32_mask::GaussianFilter_ROM_9X32_mask(sc_module_name name) : sc_module(name) 
    ...
    ,mask()
{
  CYN_ROM_INIT( sc_uint<32> , mask, ENUMS::CYN_HEX, "bdw_work/modules/GaussianFilter/BASIC/GaussianFilter_ROM_9X32_mask_0.memh", "initialize GaussianFilter_ROM_9X32_mask" ); 
